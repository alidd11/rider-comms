const CACHE_NAME = 'rider-comms-pwa-v101';
const ASSETS = [
  './', './index.html', './app.css?v=83', './app.js?v=85', './routes.css?v=38', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
