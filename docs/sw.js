const CACHE_NAME = 'rider-comms-pwa-v91';
const ASSETS = [
  './', './index.html', './app.css?v=77', './app.js?v=80', './routes.css?v=37', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
