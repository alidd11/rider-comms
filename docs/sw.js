const CACHE_NAME = 'rider-comms-pwa-v130';
const ASSETS = [
  './', './index.html', './app.css?v=103', './avatar-system.js?v=1', './app.js?v=105', './routes.css?v=39', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=2', './config.js?v=31',
