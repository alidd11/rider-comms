const CACHE_NAME = 'rider-comms-pwa-v78';
const ASSETS = [
  './', './index.html', './app.css?v=67', './app.js?v=72', './routes.css?v=31', './routes.js?v=32', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
