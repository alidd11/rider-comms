const CACHE_NAME = 'rider-comms-pwa-v83';
const ASSETS = [
  './', './index.html', './app.css?v=70', './app.js?v=76', './routes.css?v=32', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
