const CACHE_NAME = 'rider-comms-pwa-v115';
const ASSETS = [
  './', './index.html', './app.css?v=95', './app.js?v=91', './routes.css?v=39', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=2', './config.js?v=31',
