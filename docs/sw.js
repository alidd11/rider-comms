const CACHE_NAME = 'rider-comms-pwa-v118';
const ASSETS = [
  './', './index.html', './app.css?v=96', './app.js?v=94', './routes.css?v=39', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=2', './config.js?v=31',
