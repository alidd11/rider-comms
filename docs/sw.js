const CACHE_NAME = 'rider-comms-pwa-v111';
const ASSETS = [
  './', './index.html', './app.css?v=93', './app.js?v=87', './routes.css?v=39', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
