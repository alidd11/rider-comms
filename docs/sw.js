const CACHE_NAME = 'rider-comms-pwa-v131';
const ASSETS = [
  './', './index.html', './app.css?v=105', './avatar-system.js?v=1', './app.js?v=106', './routes.css?v=39', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=2', './config.js?v=31',
