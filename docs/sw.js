const CACHE_NAME = 'rider-comms-pwa-v75';
const ASSETS = [
  './', './index.html', './app.css?v=65', './app.js?v=69', './routes.css?v=31', './routes.js?v=32', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
