const CACHE_NAME = 'rider-comms-pwa-v85';
const ASSETS = [
  './', './index.html', './app.css?v=72', './app.js?v=78', './routes.css?v=33', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
