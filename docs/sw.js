const CACHE_NAME = 'rider-comms-pwa-v77';
const ASSETS = [
  './', './index.html', './app.css?v=67', './app.js?v=71', './routes.css?v=31', './routes.js?v=32', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
