const CACHE_NAME = 'rider-comms-pwa-v86';
const ASSETS = [
  './', './index.html', './app.css?v=73', './app.js?v=78', './routes.css?v=34', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
