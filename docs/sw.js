const CACHE_NAME = 'rider-comms-pwa-v73';
const ASSETS = [
  './', './index.html', './app.css?v=63', './app.js?v=67', './routes.css?v=31', './routes.js?v=32', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
