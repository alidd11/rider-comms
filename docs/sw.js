const CACHE_NAME = 'rider-comms-pwa-v84';
const ASSETS = [
  './', './index.html', './app.css?v=71', './app.js?v=77', './routes.css?v=32', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
