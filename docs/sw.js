const CACHE_NAME = 'rider-comms-pwa-v89';
const ASSETS = [
  './', './index.html', './app.css?v=76', './app.js?v=79', './routes.css?v=35', './routes.js?v=33', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
