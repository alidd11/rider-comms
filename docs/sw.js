const CACHE_NAME = 'rider-comms-pwa-v107';
const ASSETS = [
  './', './index.html', './app.css?v=89', './app.js?v=86', './routes.css?v=38', './routes.js?v=34', './movement-safety.js?v=2', './message-state.js?v=1', './config.js?v=31',
