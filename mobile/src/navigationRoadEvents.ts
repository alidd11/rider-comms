import { HIDE_NET_DENIAL_THRESHOLD } from '@rider-comms/shared';
...
function activeHazardReport(hazard: HazardReport, nowMs: number): boolean {
  return HAZARD_TYPES.has(hazard.type)
