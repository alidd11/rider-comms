...
interface AuthValue { riderId: string; client: RiderCommsClient }
...
export function AuthProvider({ children }: { children: React.ReactNode }): React.JSX.Element {
  ...
  const value = React.useMemo(() => session ? { riderId: session.riderId, client: new RiderCommsClient(API_BASE_URL, fetch, session.token) } : null, [session]);
