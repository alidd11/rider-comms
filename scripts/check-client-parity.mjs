...
for (const required of ['auth', 'group-ride', 'ride-safe', 'place-search', 'friends', 'direct-messages', 'social-realtime', 'message-read-state', 'navigation-road-ahead']) {
...
console.log(`Client parity manifest valid: ${manifest.capabilities.length} capabilities tracked; map basemaps, route-ahead alerts, maneuver glanceability, live speed and adaptive dedicated navigation aligned`);
