...
assert.match(
  pwaApp,
  /function updateNavigationPositionIcon\(\)[\s\S]*riderAvatarMapIcon\(state\.profile, true, undefined, 64, true\)/,
  'PWA navigation must keep the rider-selected avatar as the enlarged tail-free live self marker',
);
