...
- navigation: both clients now align on provider choice, route/step UI, distance units, next-turn preview, ETA/arrival, arrival handling, automatic rerouting and spoken turn/reroute/arrival prompts. Real chat ducking/audio mixing, background/locked-screen guidance and physical ride/helmet validation remain outstanding.
